const cuisines = {
    "Anhui": {
        ...
        "origin": "Origin: China's Anhui Province",
        "flavors": "Flavors: salty and fresh, light, the original flavor of wild ingredients",
    ...
    "Cantonese": {
        ...
        "origin": "Origin: China's Guangdong Province",
        "flavors": "Flavors: light, sweet, smooth, and fresh",
    ...
    "Sichuan": {
        ...
        "origin": "Origin: China's Sichuan Province",
        "flavors": "Flavors: bold, spicy (especially with Sichuan pepper), pungent",
    ...
    "Shandong": {
        ...
        "origin": "Origin: China's Shandong Province",
        "flavors": "Flavors: fresh and salty with a lot of seafood dishes",
    ...
    "Jiangsu": {
        ...
        "origin": "Origin: China's Jiangsu Province",
        "flavors": "Flavors: sweet and light",
    ...
    "Fujian": {
        ...
        "origin": "Origin: China's Fujian Province",
        "flavors": "Flavors: light but flavorful, slightly sweet and sour, with an emphasis on umami",
    ...
    "Hunan": {
        ...
        "origin": "Origin: China's Hunan Province",
        "flavors": "Flavors: hot and spicy, fresh, aromatic",
    ...
    "Zhejiang": {
        ...
        "origin": "Origin: China's Zhejiang Province",
        "dishes": ["West Lake Fish in Vinegar Gravy", "Dongpo Pork"],
        "flavors": "Flavors: fresh, soft, with a mellow fragrance",
